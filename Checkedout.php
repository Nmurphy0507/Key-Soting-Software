...
<body>
    ...
    <nav class="navbar navbar-light justify-content-center fs-3 mb-3">
        <h1><strong>Checked Out Residence Hall Keys</strong></h1>
    </nav>
    ...
    <div class="container">
        ...
        <a href="homepage.php" class="btn btn-dark mt-3 mb-3"> All Keys </a>
        <a href="Checkedin.php" class="btn btn-success mt-3 mb-3"> Checked In Keys </a>
        <a href="Checkedout.php" class="btn btn-danger mt-3 mb-3"> Checked Out Keys </a>
        <a href="add_new.php" class="btn btn-dark mt-3 mb-3 float-end"> Add New </a>
